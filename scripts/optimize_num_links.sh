...
deepwalk --format adjlist --input ./data/tmp_adjlist.txt --number_walks 10 --representatio_size 512 --walk_length 40 --window_size 2 --workers 16 --output ./data/node_information/tmp_deepwalk.embeddings
