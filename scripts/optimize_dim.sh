sudo python3 preprocess_test.py --representation_size 64 --use_tfidf --use_doc2vec
deepwalk --format adjlist --input ./data/train_adjlist.txt --number-walks 10 --representation-size 64 --walk-length 40 --window-size 2 --workers 16
...
sudo python3 preprocess_test.py --representation_size 128 --use_tfidf --use_doc2vec
deepwalk --format adjlist --input ./data/train_adjlist.txt --number-walks 10 --representation-size 128 --walk-length 40 --window-size 2 --workers 16
sudo python3 transform_dataset.py --input_file ./data/train.txt --output_name tmp  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
sudo python3 transform_dataset.py --input_file ./data/val.txt --output_name tmp_val  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
...
sudo python3 preprocess_test.py --representation_size 256 --use_tfidf --use_doc2vec
deepwalk --format adjlist --input ./data/train_adjlist.txt --number-walks 10 --representation-size 256 --walk-length 40 --window-size 2 --workers 16
sudo python3 transform_dataset.py --input_file ./data/train.txt --output_name tmp  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
sudo python3 transform_dataset.py --input_file ./data/val.txt --output_name tmp_val  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
...
sudo python3 preprocess_test.py --representation_size 512 --use_tfidf --use_doc2vec
deepwalk --format adjlist --input ./data/train_adjlist.txt --number-walks 10 --representation-size 512 --walk-length 40 --window-size 2 --workers 16
sudo python3 transform_dataset.py --input_file ./data/train.txt --output_name tmp  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
sudo python3 transform_dataset.py --input_file ./data/val.txt --output_name tmp_val  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
...
sudo python3 preprocess_test.py --representation_size 1024 --use_tfidf --use_doc2vec
deepwalk --format adjlist --input ./data/train_adjlist.txt --number-walks 10 --representation-size 1024 --walk-length 40 --window-size 2 --workers 16
sudo python3 transform_dataset.py --input_file ./data/train.txt --output_name tmp  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
sudo python3 transform_dataset.py --input_file ./data/val.txt --output_name tmp_val  --graph_embeddings_file ./data/node_information/tmp_deepwalk.embeddings --concatenate
